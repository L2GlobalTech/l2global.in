...
const footerLinks = {
    ...
    //     { label: "Salesforce Consultancy", href: "/services/salesforce-consultancy" },
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
                    ...
                    <div className="md:col-span-5">
                        ...
                        <p className="mt-6 max-w-md leading-7 text-[#6F6C90]">
                            Enterprise IT consulting delivering secure, scalable Salesforce, SAP and digital solutions for businesses worldwide
                        </p>

                        {/* Social icons */}
                        <div className="mt-6 flex items-center gap-5">
                            <Link aria-label="Facebook" href="#" className="text-[#6F6C90] transition-all duration-300 ease-out 
                            ...
                            <Link aria-label="Twitter" href="#" className="text-[#6F6C90] transition-all duration-300 ease-out 
                                 hover:-translate-y-1 hover:scale-110">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
                            ...
                            <Link aria-label="Instagram" href="#" className="text-[#6F6C90] transition-all duration-300 ease-out 
                                 hover:-translate-y-1 hover:scale-110">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
                            ...
                            <Link aria-label="LinkedIn" href="#" className="text-[#6F6C90] transition-all duration-300 ease-out 
                                 hover:-translate-y-1 hover:scale-110">
                            ...
                            <Link aria-label="YouTube" href="#" className="text-[#6F6C90] transition-all duration-300 ease-out 
                                 hover:-translate-y-1 hover:scale-110">
                                {/* <FaYoutube size={18} /> */}
                ...
                <div className="relative mt-12 border-t border-slate-200 pb-12">
                    ...
                    <div className="mt-8 flex flex-col gap-4 items-center justify-between text-[#6F6C90] md:flex-row">
                        <div className="md:flex justify-start items-center">
                            <p>Copyright {year} © l2globaltechnologies.</p>
                            <div className="flex items-center gap-3">
